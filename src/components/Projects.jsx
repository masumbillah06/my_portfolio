...
const projects = [
  ...
  },
  {
    ...
    title: 'Portfolio',
    description:
      'A developer social platform for sharing knowledge, collaborating on projects, and building a professional network.',
    tags: ['JavaScrit', 'Tailwind', 'React'],
    image: '🌐',
    github: '#',
    demo: '#',
    featured: true,
  },
  {
    ...
    title: 'HealthSync',
    description:
      'A telemedicine platform that connects patients with healthcare providers through secure video consultations and health record management.',
  ...
  },
  {
    ...
    description:
      'A drag-and-drop portfolio builder designed for creative professionals to showcase their work with stunning templates.',
    tags: ['Vue', 'Vite', 'Pinia', 'Tailwind'],
    image: '🎨',
    github: '#',
    demo: '#',
    featured: false,
