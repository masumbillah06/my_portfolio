  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-[-30%] left-[-20%] w-[70%] h-[70%] bg-[#6c63ff]/20 rounded-full blur-[120px] animate-pulse" />
        <div className="absolute bottom-[-30%] right-[-20%] w-[70%] h-[70%] bg-[#ff6b9d]/20 rounded-full blur-[120px] animate-pulse delay-1000" />
      </div>

      <div className="max-w-5xl w-full mx-auto text-center">
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold leading-tight">
          <span className="bg-linear-to-r from-[#6c63ff] via-[#a78bfa] to-[#ff6b9d] bg-clip-text text-transparent">
            Masum Billah
          </span>
        </h1>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <a
            href="#projects"
            className="px-8 py-3 rounded-full bg-linear-to-r from-[#6c63ff] to-[#7b73ff] text-white font-medium shadow-lg shadow-[#6c63ff]/30 hover:shadow-[#6c63ff]/50 hover:scale-105 transition-all duration-300"
          >
            View My Work
          </a>
          <a
            href="#contact"
            className="px-8 py-3 rounded-full border border-[#6c63ff]/50 text-[#c4c4d4] font-medium hover:bg-[#6c63ff]/10 hover:border-[#6c63ff] transition-all duration-300"
          >
            Get In Touch
          </a>
        </div>

        <div className="mt-12 flex justify-center gap-6 text-[#9a9ab0]">
          <a
        ...
        <div className="mt-8 animate-bounce">
          <a
            href="#about"
            className="inline-block text-[#9a9ab0] hover:text-[#6c63ff] transition-colors duration-300"
          >
